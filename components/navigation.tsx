    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 lg:hidden transition-all duration-500 ${
          scrolled
            ? "bg-background/70 backdrop-blur-2xl border-b border-border/20 shadow-lg shadow-background/20"
            : "bg-transparent"
        }`}
      >
        <div className="flex items-center justify-between px-6 py-4">
          <Link href="/" className="text-lg font-bold text-foreground">
            Rabindra<span className="text-primary">.</span>
          </Link>
              ...
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    ...
                    className="group flex items-center gap-3 text-2xl font-medium text-foreground hover:text-primary transition-colors"
                  >
